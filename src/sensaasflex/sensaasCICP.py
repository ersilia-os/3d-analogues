...
#execute ./sensaasCICP.py target-type target-file-name source-type source-file-name output-file-name mode
...
try:
    ...
    print('usage: sensaasCICP.py target-type target-file-name source-type source-file-name slog optim \neg:\nsensaas.py sdf DATASET/IMATINIB.sdf sdf DATASET/IMATINIB-part1.sdf slog optim')
    quit()

# sys.argv[0] is the name of the program itself
sensaasexe=sys.argv[0]
sensaasexe=re.sub('sensaasCICP\.py','',sensaasexe)
